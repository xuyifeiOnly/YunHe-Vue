...
const routes = [
  {
    ...
    handler: ({ query, services }: RouteContext<unknown, MenuQuery>) =>
      services.menuService.findList(query),
  },
  {
    method: 'GET',
    path: '/system/menu/list/parent',
    description: '父级菜单',
    permissions: ['system:menu:query'],
    handler: ({ services }: RouteContext) =>
      services.menuService.findParentList(),
  },
  {
    method: 'GET',
    path: '/system/menu/list/role',
    description: '角色菜单',
    permissions: ['system:menu:query'],
    handler: ({ query, services }: RouteContext<unknown, RoleQuery>) =>
      services.menuService.findListByRoleId(String(query.roleId ?? '')),
  },
  {
    method: 'GET',
    ...
    handler: ({ query, services }: RouteContext<unknown, IdQuery>) =>
      services.menuService.findOneById(String(query.id ?? '')),
  },
  {
    method: 'POST',
    ...
    handler: ({ body, services }: RouteContext<MenuBody>) =>
      services.menuService.create(body),
  },
  {
    method: 'PUT',
    ...
    handler: ({ body, services }: RouteContext<MenuBody>) =>
      services.menuService.update(body),
  },
  {
    method: 'DELETE',
    ...
    handler: ({ query, services }: RouteContext<unknown, IdQuery>) =>
      services.menuService.delete(String(query.id ?? '')),
  },
