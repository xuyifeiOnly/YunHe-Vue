...
const routes = [
  {
    ...
    handler: ({ body, services }: RouteContext<DictTypeBody>) =>
      services.dictService.createType(body),
  },
  {
    method: 'DELETE',
    ...
    handler: ({ query, services }: RouteContext<unknown, IdsQuery>) =>
      services.dictService.deleteType(String(query.ids ?? '')),
  },
  {
    method: 'PUT',
    ...
    handler: ({ body, services }: RouteContext<DictTypeBody>) =>
      services.dictService.updateType(body),
  },
  {
    method: 'GET',
    ...
    handler: ({ query, services }: RouteContext<unknown, Query>) =>
      services.dictService.findTypeList(query),
  },
  {
    method: 'GET',
    ...
    handler: ({ query, services }: RouteContext<unknown, IdQuery>) =>
      services.dictService.findTypeDetail(String(query.id ?? '')),
  },
  {
    method: 'POST',
    ...
    permissions: ['system:dict:create'],
    operLog: { title: '字典管理', businessType: BusinessType.INSERT },
    handler: ({ body, services }: RouteContext<DictDataBody>) =>
      services.dictService.createData(body),
  },
  {
    method: 'DELETE',
    ...
    operLog: { title: '字典管理', businessType: BusinessType.DELETE },
    handler: ({ query, services }: RouteContext<unknown, IdsQuery>) =>
      services.dictService.deleteData(String(query.ids ?? '')),
  },
  {
    method: 'PUT',
    ...
    operLog: { title: '字典管理', businessType: BusinessType.UPDATE },
    handler: ({ body, services }: RouteContext<DictDataBody>) =>
      services.dictService.updateData(body),
  },
  {
    method: 'GET',
    ...
    permissions: ['system:dict:query'],
    handler: ({ query, services }: RouteContext<unknown, Query>) =>
      services.dictService.findDataList(query),
  },
  {
    method: 'GET',
    ...
    permissions: ['system:dict:query'],
    handler: ({ query, services }: RouteContext<unknown, IdQuery>) =>
      services.dictService.findDataDetail(String(query.id ?? '')),
  },
  {
    method: 'GET',
    path: '/system/dict/data/list/type',
    description: '字典类型数据',
    permissions: ['system:dict:query'],
    handler: ({ query, services }: RouteContext<unknown, DictTypeQuery>) =>
      services.dictService.findDataByType(String(query.dictType ?? '')),
  },
  {
    method: 'DELETE',
    path: '/system/dict/clearCahche',
    description: '清理字典缓存',
    permissions: ['system:dict:delete'],
    operLog: { title: '字典管理', businessType: BusinessType.DELETE },
    handler: ({ services }: RouteContext) => services.dictService.clearCache(),
  },
