export function applySecurityHeaders(headers: Headers | Record<string, string>) {
...
function setHeader(headers: Headers | Record<string, string>, key: string, value: string) {
